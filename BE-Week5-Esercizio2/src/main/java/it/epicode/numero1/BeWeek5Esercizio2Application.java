...
import it.epicode.numero1.beans.Bevanda;
import it.epicode.numero1.beans.Elemento;
import it.epicode.numero1.beans.Ordine;
import it.epicode.numero1.beans.Pizza;
import it.epicode.numero1.beans.StatoOrdine;
import it.epicode.numero1.beans.Tavolo;
import it.epicode.numero1.beans.Topping;
import it.epicode.numero1.beans.decorators.AnanasDecorator;
import it.epicode.numero1.beans.decorators.MozzarellaDecorator;
import it.epicode.numero1.beans.decorators.PomodoroDecorator;
import it.epicode.numero1.beans.decorators.ProsciuttoDecorator;
import it.epicode.numero1.beans.decorators.SalameDecorator;


@SpringBootApplication
public class BeWeek5Esercizio2Application {

	static AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext();

	public static void main(String[] args) {
		SpringApplication.run(BeWeek5Esercizio2Application.class, args);

		ctx.scan("it.epicode.numero1");
		ctx.refresh();
